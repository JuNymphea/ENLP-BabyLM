...
def main(quinfig, config_file, wandb_ids_cache, wandb_offline = False):
    ...
    def model_init():
        ...
        if "model_name" in quinfig.general:
            ...
            checkpoint_path = f"checkpoints/run/gpt2_small/{quinfig.general.model_name}/checkpoint-{quinfig.general.checkpoint_number}"
    ...
    hf_tokenizer_cache = hf_cache / "preprocessed" / "babylm" / quinfig.data.tokenizer_name.replace("/", "_")
